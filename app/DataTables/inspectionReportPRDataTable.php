...
class inspectionReportPRDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            return '<button type="button" title="Generate Inspection Report" class="btn btn-primary btn-xs glyphicon glyphicon-plus" data-toggle="modal" data-target="#irModal"></button> ';
            })
     ...
     *
     * @param \App\inspectionReportPR $model
    ...
    {
        return 'inspectionReportPR_' . date('YmdHis');
    }
}
