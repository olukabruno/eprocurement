...
<table class="table table-condensed borderless-head tbl-custom">
  ...
  <tr>
    <th>
      <a class="btn btn-sm btn-success glyphicon glyphicon-arrow-left" href="{{route('pr.bac')}}"></a> <a class="btn btn- btn-sm btn-primary glyphicon glyphicon-print" @if(count($list) < 1) href="#" disabled @else href="{{route('pr.print',$pr->pr_form_no)}}" target="_blank" @endif></a>
    </th>
  </tr>
</thead>
</table>
