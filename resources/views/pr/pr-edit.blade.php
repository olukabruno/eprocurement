        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Edit Purchase Request</h3>
                </div>

                <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{ url('/pr/update',$edit_form->id) }}">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}

                <input type="hidden" id="pr_status" name="pr_status" value="{{$edit_form->status}}">
                <input type="hidden" id="pr_created" name="pr_created_by" value="{{ $edit_form->created_by }}">
                        <!-- pr_no -->
                        <div class="form-group {{ $errors->has('pr_number') ? ' has-error' : '' }}">
                            ...
                            <input id="pr_number" type="text" class="form-control" name="pr_number" value="{{ $edit_form->pr_form_no }}" readonly required autofocus>
                        ...
                        <div class="form-group {{ $errors->has('pr_department') ? ' has-error' : '' }} {{ $errors->has('pr_section') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4 col-xs-8">
                            <input id="pr_department" type="text" class="form-control" name="pr_department" value="{{ $edit_form->department }}" readonly required autofocus>
                            ...
                            <div class="col-md-4 col-xs-8">
                            <input id="pr_section" type="text" class="form-control" name="pr_section" placeholder="Section" value="{{ $edit_form->section }}" readonly required autofocus>
                        ...
                        <div class="row form-group {{ $errors->has('pr_purpose') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 col-xs-16">
                                    <textarea style="resize: none; height: 65px;" id="pr_purpose" class="form-control" name="pr_purpose" autofocus>{{ $edit_form->purpose }}</textarea>
                        ...
                        <div class="row form-group {{ $errors->has('pr_requestor_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="pr_requestor_name" type="text" class="form-control" placeholder="Name" name="pr_requestor_name" value="{{ $edit_form->requestor_name }}" readonly autofocus>
                        ...
                        <div class="row form-group {{ $errors->has('pr_requestor_position') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="pr_requestor_position" type="text" class="form-control" placeholder="Position" name="pr_requestor_position"  value="{{ $edit_form->requestor_position }}" readonly autofocus>
                        ...
                        <div class="row form-group {{ $errors->has('pr_supplier_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <select id="disttype" class="form-control" name="pr_supplier_type" required>
                                        <option value="Canvass" @if($edit_form->supplier_type == "Canvass") selected @endif>Canvass</option>
                                        <option value="Government Agency" @if($edit_form->supplier_type == "Government Agency") selected @endif>Government Agency</option>
                                        <option value="Sole Distributor" @if($edit_form->supplier_type == "Sole Distributor") selected @endif>Sole Distributor</option>
                                    </select>
                        ...
                        <div class="dist row form-group {{ $errors->has('pr_supplier_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="dist-name" type="text" class="form-control" placeholder="Name" name="pr_supplier_name" value="{{ $edit_form->supplier_name }}" @if($edit_form->supplier_type == "Canvass") readonly @endif autofocus>
                        ...
                        <div class="row form-group {{ $errors->has('pr_budget_alloc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input id="pr_budget_alloc" type="text" class="form-control" name="pr_budget_alloc" value="{{ old('pr_budget_alloc', number_format($edit_form->budget_alloc, 2)) }}" readonly autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-3 col-sm-offset-5"><button type="submit" class="btn btn-primary">Update</button></div>
                        </div>
                    </form>
                    </div>
            </div><!--panel-->
            ...
            <div class="col-md-8 col-sm-8 col-xs-16">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">View Purchase Request</h3>
                    </div>
                    <div class="panel-body">
