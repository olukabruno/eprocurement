                            ...
                            <table class="table table-hover table-bordered table-condensed" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo e(route("pr.items", $pr->id)); ?>' id="items" class="btn btn-primary btn-xs" title="Items"><span class="glyphicon glyphicon-th-list"></span></a>
                                            <?php 
                                                $count = App\PurchaseRequestItemModel::where('pr_form_number',$pr->pr_form_no)->count(); 
                                            ?>

                                            <?php if($count > 0): ?>
                                            <a href='<?php echo e(route("pr.close", $pr->id)); ?>' id="close_pr" class="btn btn-success btn-xs" title="Close Purchase Request"><span class="glyphicon glyphicon glyphicon-ok"></span></a>
