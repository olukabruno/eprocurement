...
<table class="table table-condensed borderless-head tbl-custom">
  ...
  <tr>
    <th>
      <a class="btn btn-sm btn-success glyphicon glyphicon-arrow-left" href="<?php echo e(route('pr.form')); ?>"></a> <a class="btn btn- btn-sm btn-primary glyphicon glyphicon-print" <?php if(count($list) < 1): ?> href="#" disabled <?php else: ?> href="<?php echo e(route('pr.print',$pr->pr_form_no)); ?>" target="_blank" <?php endif; ?>></a>
    </th>
  </tr>
</thead>
</table>
